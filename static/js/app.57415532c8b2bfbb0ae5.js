      ...
      var D = s("/5sW"),
        ...
        le = (function () {
          function e(t) {
            oe()(this, e),
              ...
              (this.branchFilter = t.branchFilter),
              (this.tagFilter =
                t.tagFilter ||
                function () {
                  return !0;
                        ...
                        .then(function (t) {
                          ...
                          try {
                            for (
                              ...
                              if (J.a.valid(g.name)) {
                                var _ =
                                    J.a.major(g.name) + "." + J.a.minor(g.name),
                                  y = J.a.patch(g.name);
                                if (y < u[_]) continue;
                                u[_] = y;
                              }
                          ...
                          try {
                            for (
                              ...
                              if (
                                ...
                                if (J.a.valid(M.name)) {
                                  var x =
                                    J.a.major(M.name) + "." + J.a.minor(M.name);
                                  if (J.a.patch(M.name) < u[x]) continue;
                                }
                                e.tags.push(M.name);
                              }
                            }
        ...
        pe = new de({
          ...
          branchFilter: function (e) {
            return !ue.includes(e) && !e.startsWith("dependabot/");
          },
          tagFilter: function (e) {
            return J.a.gte(e, "6.0.0");
          },
        }),
        me = {
          name: "navbar",
          props: ["repository"],
          components: { LogoSquare: G },
          data: function () {
            return {
                ...
                [
                  ...
                  s(
                    ...
                    [
                      ...
                      s(
                        "a",
                        { attrs: { href: "https://discord.gg/8hk5wSpSsK" } },
                        [e._v("FAQ")]
                      ),
                    ],
                    1
            ...
            [
              s(
                ...
                [
                  ...
                  e._v(" "),
                  s("p", [
                    e._v("A feature-rich Hypixel API wrapper for Node.js"),
                  ]),
                  e._v(" "),
                  s("p", [
        ...
        Ae = [],
        Ne = { render: je, staticRenderFns: Ae },
        Oe = Ne,
        Ve = s("VU/8"),
        He = a,
        ...
        Je = {
          ...
          mounted: function () {
            ...
            this.darkMode && this.$el.classList.add("dark"),
              ze ||
                (ze = new Ge.a(function () {
                  (e.konami = !0), e.poop(), ze.disable();
                }));
          },
        },
        Ke = function () {
        ...
        Ye = [],
        Qe = { render: Ke, staticRenderFns: Ye },
        Xe = Qe,
        et = s("VU/8"),
        tt = o,
        st = et(Je, Xe, !1, tt, null, null),
        rt = st.exports,
        at = s("/ocq"),
          ...
          function () {
            ...
            return s("div", { staticClass: "info-item" }, [
              ...
              s("p", [
                ...
                e._v(" is a feature-rich "),
                s("a", { attrs: { href: "https://api.hypixel.net" } }, [
                  e._v("Hypixel API"),
                ]),
                e._v(" wrapper for Node.js. "),
                s("br"),
              ]),
            ]);
          },
        ...
        Ot = [],
        Vt = { render: Nt, staticRenderFns: Ot },
        Ht = Vt,
        Bt = s("VU/8"),
        Wt = Bt(At, Ht, !1, null, null, null),
        It = Wt.exports,
        ...
        Jt = [],
        Kt = { render: zt, staticRenderFns: Jt },
        Yt = Kt,
        Qt = s("VU/8"),
        Xt = h,
        es = Qt(Gt, Yt, !1, Xt, null, null),
        ts = es.exports,
        ss = {
          name: "docs-loader",
        ...
        js = {
          ...
          mounted: function () {
            ...
            this.$nextTick(function () {
              ...
              try {
                for (
                  var a, o = Y()(e.$el.querySelectorAll("pre code"));
                  !(t = (a = o.next()).done);
                  t = !0
                ) {
                  i(a.value);
        ...
        Js = [],
        Ks = { render: zs, staticRenderFns: Js },
        Ys = Ks,
        Qs = s("VU/8"),
        Xs = Qs(Gs, Ys, !1, null, null, null),
        er = Xs.exports,
        tr = {
          name: "types",
        ...
        Ar = [],
        Nr = { render: jr, staticRenderFns: Ar },
        Or = Nr,
        Vr = s("VU/8"),
        Hr = w,
        ...
        zr = [],
        Jr = { render: Gr, staticRenderFns: zr },
        Kr = Jr,
        Yr = s("VU/8"),
        Qr = M,
        Xr = Yr(Ir, Kr, !1, Qr, null, null),
        ea = Xr.exports,
        ta = {
          name: "class-event",
          props: ["event", "docs"],
          ...
          computed: {
            results: function () {
              var e = this.fuse.search(this.search),
                ...
                r = void 0;
              try {
                for (var a, o = Y()(e); !(t = (a = o.next()).done); t = !0) {
                  var n = a.value;
                  "Class" !== n.item.type
        ...
        Oa = [],
        Va = { render: Na, staticRenderFns: Oa },
        Ha = Va,
        Ba = s("VU/8"),
        Wa = R,
        Ia = Ba(Aa, Ha, !1, Wa, null, null),
        Ga = Ia.exports;
      D.a.use(at.a);
      var za = new at.a({
          routes: [
        ...
        Ya = [],
        Qa = { render: Ka, staticRenderFns: Ya },
        Xa = Qa,
        eo = s("VU/8"),
        to = E,
        so = eo(Ja, Xa, !1, to, null, null),
        ro = so.exports,
        ao = { name: "slide" },
        oo = function () {
          var e = this,
...
//# sourceMappingURL=app.57415532c8b2bfbb0ae5.js.map
